...
{
    public partial class evRevenueRatio : Form
    {
        public evRevenueRatio()
        {
            InitializeComponent();
        ...
        private void btn_calc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                label5.Text = $"{(market + net) / revenue}";
                label5.Visible = true;
            }
            catch
            {
                MessageBox.Show("Please Enter Correct Values");
                txt_market.Text = txt_net.Text = txt_revenue.Text = "";
            }
        }
        private void txt_percentage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                float net = float.Parse(txt_net.Text);
                float revenue = float.Parse(txt_revenue.Text);
                label5.Text = $"{((market + net) / revenue) * 100}%";
                label5.Visible = true;
            }
            catch
            {
        ...
        private void evRevenueRatio_KeyDown(object sender, KeyEventArgs e)
        {

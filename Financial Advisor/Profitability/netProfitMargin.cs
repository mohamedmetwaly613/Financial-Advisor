...
{
    public partial class netProfitMargin : Form
    {
        ...
        private void btn_calc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                label5.Text = $"{net / revenue}";
                label5.Visible = true;
            }
            catch
            {
                MessageBox.Show("Please Enter Correct Values");
                txt_net.Text = txt_revenue.Text = "";
            }
        }
        ...
        private void netProfitMargin_KeyDown(object sender, KeyEventArgs e)
        {
